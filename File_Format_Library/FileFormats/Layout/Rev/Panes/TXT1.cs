...
namespace LayoutBXLYT.Revolution
{
    public class TXT1 : PAN1, ITextPane
    {
        ...
        [DisplayName("直线对齐"), CategoryAttribute("字体")]
        ...
        [DisplayName("阴影大小"), CategoryAttribute("阴影")]
        public Vector2F ShadowXYSize { get; set; }

        [DisplayName("阴影前景色"), CategoryAttribute("阴影")]
        public STColor8 ShadowForeColor { get; set; }

        [DisplayName("阴影背景色"), CategoryAttribute("阴影")]
        ...
        [DisplayName("每个字符转换"), CategoryAttribute("字体")]
