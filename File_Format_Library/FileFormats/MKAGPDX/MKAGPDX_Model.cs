...
namespace FirstPlugin
{
    public class MKAGPDX_Model : TreeNodeFile, IFileFormat
    {
        ...
        public string[] Description { get; set; } = new string[] { "马里奥赛车街机版GP DX" };
        ...
        class MenuExt : IFileMenuExtension
        {
            ...
            public MenuExt()
            {
                toolExt[0] = new STToolStripItem("模型");
                toolExt[0].DropDownItems.Add(new STToolStripItem("批量导出(MKAGPDX .bin)", BatchExport));
                toolExt[0].DropDownItems.Add(new STToolStripItem("组合批量导出(MKAGPDX .bin)", BatchExportCombined));
            }
