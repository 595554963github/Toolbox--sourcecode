...
namespace FirstPlugin
{
    public class NUTEXB : STGenericTexture, IFileFormat, IContextMenuNode, ISingleTextureIconLoader
    {
        ...
        public string[] Description { get; set; } = new string[] { "万代南梦宫纹理" };
        ...
        public void Read(FileReader reader)
        {
            ...
            if (magic != "XET")
                throw new Exception($"无效的魔术头!预期XET但得到了{magic}");
        ...
        public static NUTEXImageFormat ConvertGenericToNutFormat(TEX_FORMAT nutFormat)
        {
            switch (nutFormat)
            {
                ...
                default:
                    throw new Exception($"无法转换格式{nutFormat}");
            }
        }
        ...
        public override ToolStripItem[] GetContextMenuItems()
        {
            ...
            Items.Add(new STToolStipMenuItem("使用尺寸限制", null, UseSizeRestrictionsAction, Keys.Control | Keys.U)
            ...
            Items.Add(new STToolStipMenuItem("强制填充较小的文件大小", null, PaddingToggle, Keys.Control | Keys.P)
