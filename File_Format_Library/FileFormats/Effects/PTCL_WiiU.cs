    ...
    public class PTCL_WiiU
    {
        public class Header
        {
            ...
            public void Read(FileReader reader, PTCL pctl)
            {
                ...
                var textureFolder = new PTCL.Header.TextureFolder("纹理");
        ...
        public class TextureInfo : STGenericTexture
        {
            ...
            public override void Replace(string FileName)
            {
                ...
                if (ftex.texture != null)
                {
                    ...
                    if (ImageData.Length != size)
                        MessageBox.Show($"图像大小不匹配!确保mip map计数、格式、高度和宽度都相同!原始尺寸{size}导入{ImageData.Length}");
            ...
            {
                throw new NotImplementedException("无法设置图像数据!操作未实施!");
            }
            ...
            private void ConvertFormat()
            {
                switch (SurfFormat)
                {
                    ...
                    case SurfaceFormat.TCS_R5_G6_B5_UNORM:
                        ...
                        break;
                    default:
                        throw new Exception("格式不受支持! " + SurfFormat);
                }
            }
