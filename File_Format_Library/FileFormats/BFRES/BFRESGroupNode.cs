...
namespace Bfres.Structs
{
    ...
    public class BFRESGroupNode : STGenericWrapper, IContextMenuNode
    {
        ...
        public ToolStripItem[] GetContextMenuItems()
        {
            ...
            Items.Add(new ToolStripMenuItem("导出所有", null, ExportAllAction, Keys.Control | Keys.E));
            ...
            Items.Add(new STToolStipMenuItem("清理", null, ClearAction, Keys.Control | Keys.C));
        ...
        {
            var result = MessageBox.Show("您确定要清除此部分吗?这无法撤消!",
        ...
        private string SetName()
        {
            switch (Type)
            {
                case BRESGroupType.Models: return "模型";
                ...
                case BRESGroupType.ColorAnim: return "颜色动画";
                ...
                case BRESGroupType.Embedded: return "嵌入文件";
