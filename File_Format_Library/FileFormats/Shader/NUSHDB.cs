...
namespace FirstPlugin
{
    public class NUSHDB : TreeNodeFile, IFileFormat
    {
        ...
        public string[] Description { get; set; } = new string[] { "万代南梦宫二进制着色器数据" };
        ...
        public class ShaderProgram : TreeNodeCustom
        {
            public ShaderProgram()
            {
                ...
                ContextMenuStrip.Items.Add(new ToolStripMenuItem("导出二进制原始数据", null, ExportBinary, Keys.Control | Keys.B));
            }
