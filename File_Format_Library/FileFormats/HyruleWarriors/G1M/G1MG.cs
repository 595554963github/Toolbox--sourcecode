    ...
    public class G1MG : G1MChunkCommon
    {
            ...
            for (int i = 0; i < numChunks; i++)
            {
                ...
                switch (chunkMagic)
                {
                    ...
                    case 0x00010009: //Level of detail info
                        ...
                        break;
                    default:
                        Console.WriteLine("未知块! " + chunkMagic.ToString());
                        break;
                }
        ...
        private void ToGenericMeshes(bool isBigEndian)
        {
            foreach (SubMeshInfo meshInfo in SubMeshInfos) {
                ...
                genericMesh.Text = $"网格_{GenericMeshes.Count}";
                ...
                mat.Text = $"材质_{meshInfo.TextureID}";
        ...
        public uint Stride
        {
            get
            {
                if      (DataType == FaceType.Byte) return 1;
                    ...
                    throw new Exception("未知的索引步长! " + DataType);
            }
        }
            ...
            using (var reader = new FileReader(BufferData))
            {
                ...
                switch (DataType)
                {
                    ...
                    case FaceType.UInt32:
                        ...
                        break;
                    default:
                        throw new Exception("未知类型! " + DataType);
                }
            }
        }
