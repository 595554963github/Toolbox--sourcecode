...
namespace FirstPlugin
{
    public partial class GTXTextureImporter : STForm
    {
        ...
        private void tileModeCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var result = MessageBox.Show("警告!只有改变平铺模式，除非你知道你在做什么!", "纹理导入器", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
        ...
        private void InitializeComponent()
        {
            ...
            this.chkBc4Alpha.Text = "BC4阿尔法通道";
            ...
            this.chkOriginalMipCount.Text = "使用原始Mip计数";
