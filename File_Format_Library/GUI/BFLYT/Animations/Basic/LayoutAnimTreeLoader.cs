...
namespace LayoutBXLYT
{
    ...
    public class AnimInfoWrapper : TreeNode, IContextMenuNode
    {
        ...
        public ToolStripItem[] GetContextMenuItems()
        {
            ...
            Items.Add(new ToolStripMenuItem("清除组", null, ClearGroups, Keys.Control | Keys.C));
    ...
    public class GroupAnimWrapper : TreeNode, IContextMenuNode
    {
        ...
        public ToolStripItem[] GetContextMenuItems()
        {
            ...
            Items.Add(new ToolStripMenuItem("清理组", null, ClearGroups, Keys.Control | Keys.C));
            return Items.ToArray();
        }
    ...
    public class GroupWrapper : TreeNode, IContextMenuNode
    {
        ...
        public ToolStripItem[] GetContextMenuItems()
        {
            ...
            Items.Add(new ToolStripMenuItem("移除组", null, RemoveGroup, Keys.Delete));
            Items.Add(new ToolStripMenuItem("清理目标", null, ClearTargets, Keys.Control | Keys.C));
            return Items.ToArray();
        }
    ...
    public class GroupTargetWrapper : TreeNode, IContextMenuNode
    {
        ...
        public ToolStripItem[] GetContextMenuItems()
        {
            ...
            Items.Add(new ToolStripMenuItem("清除键", null, RemoveKeys, Keys.Control | Keys.C));
            return Items.ToArray();
        }
