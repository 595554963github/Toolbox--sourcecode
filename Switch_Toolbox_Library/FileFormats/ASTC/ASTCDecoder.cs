    ...
    public static class ASTCDecoder
    {
            ...
            switch (IntEncoded.GetEncoding())
            {
                ...
                case IntegerEncoded.EIntegerEncoding.Trit:
                {
                    ...
                    switch (BitLength)
                    {
                        ...
                        default:
                            throw new ASTCDecoderException("文本权重的trit编码无效");
                    }
                ...
                case IntegerEncoded.EIntegerEncoding.Quint:
                {
                    ...
                    switch (BitLength)
                    {
                        ...
                        default:
                            throw new ASTCDecoderException("texel权重的quint编码无效");
                    }
            ...
            ref int     ColorValuesPosition)
        {
            switch (ColorEndpointMode)
            {
                ...
                default:
                    throw new ASTCDecoderException("不支持的颜色端点模式(是HDR吗?)");
            }
        }
                ...
                switch (IntEncoded.GetEncoding())
                {
                    ...
                    case IntegerEncoded.EIntegerEncoding.Trit:
                    {
                        ...
                        switch (BitLength)
                        {
                            ...
                            default:
                                throw new ASTCDecoderException("颜色值不受支持的trit编码!");
                        }
                    ...
                    case IntegerEncoded.EIntegerEncoding.Quint:
                    {
                        ...
                        switch (BitLength)
                        {
                            ...
                            default:
                                throw new ASTCDecoderException("颜色值不受支持的quint编码!");
                        }
                        break;
                    }   
                }
