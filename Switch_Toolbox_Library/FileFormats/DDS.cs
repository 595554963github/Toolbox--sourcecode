...
namespace Toolbox.Library
{
    ...
    public class DDS : STGenericTexture, IFileFormat, IContextMenuNode
    {
        ...
        public string[] Description { get; set; } = new string[] { "微软DDS" };
        ...
        public void Load(BinaryDataReader reader)
        {
            ...
            if (Magic != "DDS ")
            {
                MessageBox.Show("该文件似乎不是有效的DDS文件.");
            }
            ...
            if (Compressed)
            {
                ...
                switch (dds.Format)
                {
                    ...
                    case TEX_FORMAT.BC6H_SF16:
                        ...
                        break;
                    default:
                        throw new Exception("不支持的格式! " + dds.Format);
                }
